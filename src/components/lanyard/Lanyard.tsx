/* Ported from react-bits Lanyard (MIT):
 * https://github.com/DavidHDev/react-bits/tree/main/src/ts-tailwind/Components/Lanyard
 */
...
import cardUrl from "@/assets/lanyard/card.glb?url";
import lanyardUrl from "@/assets/lanyard/lanyard.png?url";
import cardFrontUrl from "@/assets/lanyard/card-front.png?url";
import cardBackUrl from "@/assets/lanyard/card-back.png?url";
...
function Band({
  ...
  return (
    <>
      ...
      <mesh ref={band}>
        <meshLineGeometry />
        {/* @ts-expect-error MeshLineMaterial R3F types require constructor args */}
        <meshLineMaterial
          color="white"
          depthTest={false}
